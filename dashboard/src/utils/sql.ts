import { TDashboardStateValues, TPayloadForSQL, TPayloadForSQLSnippet } from '~/model';
...
export function postProcessSQLQuery(post_process: TFunctionString, data: any, state: TDashboardStateValues) {
