    ...
    <>
      <Group>
        ...
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <Checkbox checked={field.value} onChange={e => field.onChange(e.currentTarget.checked)} label="Clearable" />
          )}
        />
      </Group>
      <Controller
        ...
        control={control}
        render={({ field }) => (
          <Select data={inputFormatOptions} label="Display Format" {...field} />
        )}
      />
    </>
  )
