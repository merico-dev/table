...
export function getSQLParams(context: ContextInfoContextType, definitions: IDashboardDefinition) {
...
export function explainSQL(sql: string, context: ContextInfoContextType, definitions: IDashboardDefinition) {
  try {
