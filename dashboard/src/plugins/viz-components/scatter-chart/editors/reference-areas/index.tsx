...
import { ReferenceAreaField } from '~/plugins/common-echarts-fields/reference-area/field';
import { getNewReferenceArea } from '~/plugins/common-echarts-fields/reference-area/types';
